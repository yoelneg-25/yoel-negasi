      ...
      <header className="flex-shrink-0 bg-[#080810]/95 backdrop-blur-xl border-b border-white/[0.06] px-5 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/projects/opspilot" className="flex items-center gap-1.5 text-xs text-white/35 hover:text-white/65 transition-colors group">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-sora font-bold text-sm">OpsPilot</span>
